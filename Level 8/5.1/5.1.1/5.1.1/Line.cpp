 ...
 * Version 1.6: 2025-01-21 - Added the Draw() function. Overridden from Shape Class.
 ******************************************************************************/
...
namespace DavidLeather
{
	namespace CAD
	{
		...
		Line::~Line()
		{
			std::cout << "Line Destructing in 3, 2, 1,..." << std::endl;
		};
		...
		std::string Line::ToString() const
		{
			...
			output_stream << " The line from (" << m_pnt1.X() << ", ";
		...
		{
			std::cout << "This is a drawing of the line from " << m_pnt1;
			std::cout << " to " << m_pnt2 << "." << std::endl;
		}
