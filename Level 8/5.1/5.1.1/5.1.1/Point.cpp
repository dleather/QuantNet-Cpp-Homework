 ...
 * Version 1.14: 2025-01-21 - Added Draw() function. Overridden from Shape class.
 ******************************************************************************/
...
namespace DavidLeather
{
	namespace CAD
	{
		...
		Point::~Point()
		{
			std::cout << "Point Destructing in 3, 2, 1,..." << std::endl;
		}
		...
		{
			std::cout << "This is a drawing of " << *this << "." << std::endl;
		}
